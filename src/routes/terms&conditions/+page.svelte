<div class="text-white flex flex-col gap-3">
  <h1
    class="text-red-600 font-[Montserrat] text-5xl justify-center flex mt-10 underline decoration-2"
  >
    Terms & Conditions
  </h1>

  <p class="font-[Lato] mt-5 text-lg">
    ...
    section or module of the website. Welcome to our website. If you continue to
    browse and use this website you are agreeing to comply with and be bound by
    the following terms and conditions of use, which together with our privacy
    policy govern ADDY FITNESS''s relationship with you in relation to this
    website.
  </p>

  <p class="font-[Lato] text-lg">
    The term 'ADDY FITNESS' or 'us' or 'we' refers to the owner of the website
    whose registered/operational office is 333/B, Chritian Sahi, Sutahat,
    Cuttack Cuttack ODISHA 753001. The term 'you' refers to the user or viewer
    of our website.
  </p>
  <p>The use of this website is subject to the following terms of use:</p>
  <ul class="list-disc font-[Lato] pl-10">
    <li>
    ...
    <li>
      ...
      without ADDY FITNESS’s prior written consent.
    </li>
    <li>
